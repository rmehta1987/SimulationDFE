...
class VIPosterior(NeuralPosterior):
    ...
    def __init__(
        ...
        self._q_type = q
        self._q_parameters = parameters
        self._q_modules = modules
    ...
    def train(
        ...
        **kwargs,
        ...
        if retrain_from_scratch:
            self.set_q(self._q_type, self._q_parameters, self._q_modules)  # type: ignore
        ...
        return self
    def evaluate2(self, quality_control_metric: str = "psis", N: int = int(5e4)) -> None:
        
        quality_control_fn, quality_control_msg = get_quality_metric(quality_control_metric)
