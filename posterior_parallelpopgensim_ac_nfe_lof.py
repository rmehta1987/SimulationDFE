...
def main(argv):
    ...
    get_sim_data('/home/rahul/PopGen/SimulationSFS/sfs_lof_sim_data.npy')
    ...
    for i in range(0,rounds):
        ...
        potential_function_estimator = infer_posterior.append_simulations(theta, x, data_device=the_device ).train(force_first_round_loss=True, training_batch_size=20, show_train_summary=True)
        ...
        posterior_build = posterior.set_default_x(true_x).train(n_particles=60, max_num_iters=50, quality_control=False)
