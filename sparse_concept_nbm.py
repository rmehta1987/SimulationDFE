...
class ConceptNNBasesNary(nn.Module):
    ...
    def __init__(
        ...
        for dim in hidden_dims:
            layers.append(sl.SparseLinear(in_features=input_dim, out_features=dim))
        ...
        # Last MLP layer
        layers.append(sl.SparseLinear(in_features=input_dim, out_features=num_bases))
...
class ConceptNBMNary(nn.Module):
    ...
    def __init__(
        ...
        if polynomial:
            ...
            self.classifier = sl.SparseLinear(
