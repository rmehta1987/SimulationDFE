...
from sbi.inference import SNPE, prepare_for_sbi, simulate_for_sbi, SNLE, MNLE, SNRE
...
inferer = SNLE(prior, show_progress_bars=True, device='cuda', density_estimator=default_network_type)
